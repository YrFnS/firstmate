...
| Keys | `herdr pane send-keys <pane> <enter-or-escape-or-ctrl+c> --session <name>` | Enter and Escape worked; Ctrl-C interrupted foreground work. |
...
| Keys | `send-key ... <enter-or-escape-or-ctrl-c>` | All shared key operations worked. |
